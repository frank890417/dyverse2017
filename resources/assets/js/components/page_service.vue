    ...
    .container
      .row
        .col-sm-6
          h1 Dyverse Studio
            span.small 歧響音樂
          h4 綺想、歧響，延展聽覺世界的無限可能
          p 歧響音樂擁有台灣的在地熱情，堅持日系的精雕細琢<br>作品橫跨古典到流行，主流到非主流<br>熱衷跨領域進行各種嘗試，以創造多樣風格的絢爛詩篇。
        .col-sm-6
        ...
        .col-sm-10
          .row
            .col-sm-6.col-member(v-for="member in members")
              .photo(:style="{'background-image': `url(${member.img})`}")
              h4 {{ member.job }}
              h2 {{ member.name }}
...
擅長音樂風格：動漫音樂。
興趣：音樂、酒、動畫、遊戲。`,
          img: "/img/members/tetsuyanao.jpg"
        }
      ]
    }
  },
